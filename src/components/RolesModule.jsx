...
const RolesModule = () => {
  ...
  return (
    <div>
      <div className="bg-gray-50 shadow-lg rounded-b-3xl py-8 px-4">
      ...
      <div className="px-4 py-6 border border-gray-300 rounded-lg w-[95%] mx-auto mt-8">
        <div className="bg-gray-50 border-gray-500 py-4 px-8">
          <div className="bg-white">
            <div className="bg-white flex justify-between border border-gray-300 hover:border hover:border-gray-500 rounded-sm">
              ...
              />
              <button className="px-6 border-l border-gray-400 hover:bg-gray-50 cursor-pointer hover:text-gray-500 text-gray-400 font-semibold">
                Search
              </button>
            </div>
            <button
