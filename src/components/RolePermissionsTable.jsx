...
const RolePermissionsTable = ({
  ...
  return (
    <div className="overflow-auto max-h-[300px] border border-gray-200 rounded-xl mt-4">
      <table className="min-w-[1166.5px] text-sm">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-4">
              ...
              <div className="flex-1 border-r border-gray-300 pr-4">
                ...
                <label className="flex items-center gap-2">
                  <input type="checkbox" /> View Profile Details
                </label>
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex items-center gap-2">
                    <input type="checkbox" /> Payment Maker
                  </label>
                  <label className="flex items-center gap-2">
                    <input type="checkbox" /> Payment Checker
                  </label>
                  <label className="flex items-center gap-2">
                    <input type="checkbox" /> Payment Manage Approval
                  </label>
                </div>
              </div>
            </div>
